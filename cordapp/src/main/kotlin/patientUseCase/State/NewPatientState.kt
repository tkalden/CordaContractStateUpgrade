...
import patientUseCase.PatientSchema.PatientSchemaV2
...
@CordaSerializable
class NewPatientState(val patient: NewPatient,
    ...
    override fun generateMappedObject(schema: MappedSchema): PersistentState {
        return if (schema is PatientSchemaV2) {
            PatientSchemaV2.NewPatient(
    ...
    override fun supportedSchemas(): Iterable<MappedSchema> = listOf(PatientSchemaV2())
